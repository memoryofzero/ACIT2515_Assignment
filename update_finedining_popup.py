...
class UpdateFinediningPopup(tk.Frame):
    ...
    def __init__(self, parent, close_callback, id):
        ...
        tk.Label(self, text="Number of Michelin Stars:").grid(row=5, column=1)
        self._num_michelin_stars = tk.Entry(self)
        self._num_michelin_stars.grid(row=5, column=2)
        tk.Label(self, text="Chef's Name:").grid(row=6, column=1)
        self._chef_name = tk.Entry(self)
        self._chef_name.grid(row=6, column=2)
